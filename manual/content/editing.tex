...
\begin{minipage}[t]{0.4\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{%
        \fbox{\includegraphics[width=\textwidth]{panel_empty_root}}}
    \label{fig1}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{%
        \fbox{\includegraphics[width=\textwidth]{panel_empty_dummy}}}
    \label{fig1}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{%
        \fbox{\includegraphics[width=\textwidth]{panel_mesh_trimesh}}}
    \label{fig1}
\end{minipage}
...
\begin{minipage}[t]{0.3\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{%
        \fbox{\includegraphics[width=\textwidth]{panel_mesh_danglymesh}}}
    \label{fig1}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{%
        \fbox{\includegraphics[width=\textwidth]{panel_animations}}}
    \label{fig1}
\end{minipage}
...
\begin{description}[leftmargin=8em,style=nextline]
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_add}} Add \& Delete] Add or delete an animation. Note that the keyframes will be deleted too. If an animation is to be excluded from exporting, it may be preferable to simply disable it by clicking the eye symbol next to it's name.
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_moveback}} Move Back]Move the animation and its keyframes to the end of the timeline for easier editing. This operation will fail if keyframes are shared between multiple animations.
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_focus}} Focus] Sets the start and end frames of the timeline to the currently selected animation.
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_clone}} Clone]Copies an animation and its keyframes. The copy is added to the end of the timeline.   
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_scale}} Scale]Scales an animation up or down. If the fps value is not adjusted this will result in the animation being slowed down or speed up. This operation will fail if keyframes are shared between multiple animations.
    \item[{\includegraphics[height=0.7\baselineskip]{icons/op_pad}} Pad \& Crop]Add or remove a specific amount of keyframes at the start or end of an animation. This operation will fail if keyframes are shared between multiple animations.
\end{description}