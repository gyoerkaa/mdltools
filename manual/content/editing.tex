...
\begin{propertyAurora}{Start \& End}
    The animations first and last frames.
\end{propertyAurora}
...
A number of tools are available to make editing of animations easier. Some of the tools will not work if the animations are convoluted, i.e. start and end frames are overlapping.
...
\begin{description}
    ...
    \item[Move Back] Move the animation and its keyframes to the end of the timeline for easier editing.
    ...
    \item[Scale] Scales an animation up or down. If the fps values is not adjusted this will result in the animation being slowed down or speed up.
