...
Animeshes are Trimeshes with animated UV coordinates or vertices. Neverblender is able to
export keyframes for aniamted UV's. It is recommended to use the AnimAll Add-On to 
enable insertion of keyframes for UV coordinates. The number of 
animated keyframes for Animmeshes is limited to 
two (start and beginning of the animation).
