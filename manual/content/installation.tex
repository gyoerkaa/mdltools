...
Once installed, additional entries are available in Blender's File menu: \menu{Import > Aurora (.mdl)} and 
\menu{Export > Aurora (.mdl)}. Furthermore several new panels are added to the Object Properties window:
\begin{itemize}
